...
import com.example.lcdemo.base.support.StrKit;
import java.io.File;
...
public class ToolUtil {
     ...
     * @return
     */
    public static String getBankIconPath(String filePath, String name) {
     ...
     * @return
     */
    public static String getFormaterString(int num,String begin) {
        DecimalFormat df = new DecimalFormat(begin+"000000");
...
//	}
    ...
    public static String generateOrderNO() {
        String prefix = DateUtil.getTime("88yyyyMMDDHHmmss");
